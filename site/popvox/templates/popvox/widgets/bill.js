...
document.write('<style>.popvoxwidget { width: 162px; height: 47px; background-image: url(https://www.popvox.com/media/icons/speak_up_{% if bill %}ext{% else %}bubble{% endif %}.png); cursor: pointer; text-align: left } {% if not bill %}.popvoxwidget:hover { background-position: left bottom }{% endif %}</style>');
