...
document.write('</style>');
document.write('<a class="popvoxwidget {% if request.GET.title == "1" %}wide{% else %}small{% endif %}"' 
	...
	{% if request.GET.title == "1" %}+ '<div style="display: block; float: left; width: 180px; padding: 7px 0 0 14px;"><p class="billtitle">{{bill.title|truncatewords:15}}</p><p class="speakup">SPEAK UP at POPVOX</p></div>'{% endif %}
	+ '</a>')
