...
supercommittee_bill_list = None
supercommittee_bill_list_ids = None

def load_supercommittee_bill_list():
	global supercommittee_bill_list
	global supercommittee_bill_list_ids
	
	if supercommittee_bill_list != None: return supercommittee_bill_list
	...
	return supercommittee_bill_list

@strong_cache
def supercommittee(request):
	load_supercommittee_bill_list()
