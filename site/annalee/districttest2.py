...
def getuspszip(address1, city, state):
    ...
    #fun with slices! This knocks the semicolon out of the string
    uspszip = uspszip[1:]
...
#quick and dirty fix so I can feed it individual addresses based on email
addr = PostalAddress.objects.get(user__email=sys.argv[1])
