...
urlpatterns = patterns('',
    ...
    (r'^(|congress|congress/letters|organization|about|about/team|about/principles|about/whatispopvox|about/whyitworks|about/contact|about/testimonials|advertising|faq|blog_template|features/opendataday2011|signup|testing)$', 'popvox.views.main.staticpage'), # maps arg to a template file name without checking for safety, so options must be defined in the regex explicitly
    ...
    (r'^ajax/regulations/us/(?P<agency>[a-zA-Z]+)/(?P<regnumber>[a-zA-Z0-9-]+)?/([0-9])/comments$', "popvox.views.bills.regreport_comments"),
    ...
    (r'^widgets/minicampaign$', "popvox.views.widgets.minicampaign"),
    ...
    (r'^fiscalcliff$', 'popvox.views.features.fiscal_cliff'),
    ...
    (r'^api/v1/bill/(\d+)/sentiment$', 'popvox.views.api.bill_sentiment'),
