...
urlpatterns = patterns('',
	(r'^(|about|about/team|about/principles|about/howitworks|about/contact|legal|advertising|press|jobs|blog_template)$', 'popvox.views.main.staticpage'), # maps arg to a template file name without checking for safety, so options must be defined in the regex explicitly
	...
	(r'^ajax/home/legstaff/bill_categories$', 'popvox.views.home.legstaff_bill_categories'),
	(r'^ajax/home/legstaff/bill_category_panel$', 'popvox.views.home.legstaff_bill_category_panel'),
